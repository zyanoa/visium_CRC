...
# Repository-root path. The previous GitHub version incorrectly used
# scripts/00_utils/MIA_function.R, but the function is stored in 00_utils/.
mia_function_file <- file.path("00_utils", "MIA_function.R")
...
stopifnot(file.exists(mia_function_file))
